...
Rails::Initializer.run do |config|
  ...
  config.load_paths += %W( #{RAILS_ROOT}/app/sweepers #{RAILS_ROOT}/app/mailers )
  ...
  config.action_controller.session = {
    :session_key => '_refactormycode_session_id',
    :secret      => '45d2cbfe36ca05f80bb6ce48328b48cd'
  }
  
  # FIXME Disable request forgery protection in test environment
  # For some reason it is causing some problems when posting refactorings
